...
[ Author ]	김정민
[ Version ]	0.0.0.2
[ Text ]	마스터레벨 1(401레벨) 이상에서	일주퀘스트가 받아지지 않는 현상 수정							
[ Desc ]									
--]]
--================================================================================================================
...
function Ep6_SendCompleteQS(QS, objIndex)
	...
	elseif QS == 7 then
		...
		elseif CharClass == CLASS_MAGUMSA or CharClass == CLASS_DARKLORD or CharClass == CLASS_MONK or CharClass == CLASS_LANCER then	-- 다크로드, 마검사, 레이지파이터, 그로우랜서
			if UserLv < 261 then
				LuaQuestClass:SetQuestSwitch(Ep6, 2, objIndex)
