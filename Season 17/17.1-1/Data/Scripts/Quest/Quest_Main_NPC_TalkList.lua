...
function Ep2_NPCTalkList(iObjIndex)
	...
	if CharClass == CLASS_KNIGHT or CharClass == CLASS_WIZARD or CharClass == CLASS_ELF or CharClass == CLASS_SUMMONER or CharClass == CLASS_MAGUMSA or CharClass == CLASS_DARKLORD or CharClass == CLASS_MONK or CharClass == CLASS_LANCER then	-- 흑기사, 흑마법사, 요정, 소환술사, 다크로드, 마검사, 레이지파이터, 그로우랜서
		if CharMaster == 0 then
			...
			elseif UserLv >= 180 and UserLv <= 269 then -- 카오스캐슬 2구간
				QS = LuaQuestClass:GetQuestSwitch(Ep2, iObjIndex)
			...
			elseif UserLv >= 270 and UserLv <= 349 then -- 카오스캐슬 3구간
				QS = LuaQuestClass:GetQuestSwitch(Ep2, iObjIndex)
			...
			elseif UserLv >= 350 and UserLv <= 400 then -- 카오스캐슬 4구간
				QS = LuaQuestClass:GetQuestSwitch(Ep2, iObjIndex)
		...
		elseif CharMaster == 1 then
			if UserLv >= 400 and UserLv <= 500 then -- 카오스캐슬 5구간
				QS = LuaQuestClass:GetQuestSwitch(Ep2, iObjIndex)
			...
			elseif UserLv >= 501 and UserLv <= 650 then -- 카오스캐슬 6구간
				QS = LuaQuestClass:GetQuestSwitch(Ep2, iObjIndex)
			...
			elseif UserLv >= 651 and UserLv <= 770 then -- 카오스캐슬 7구간
				QS = LuaQuestClass:GetQuestSwitch(Ep2, iObjIndex)
...
function Ep3_NPCTalkList(iObjIndex)
	...
	if CharClass == CLASS_KNIGHT or CharClass == CLASS_WIZARD or CharClass == CLASS_ELF or CharClass == CLASS_SUMMONER or CharClass == CLASS_MAGUMSA or CharClass == CLASS_DARKLORD or CharClass == CLASS_MONK or CharClass == CLASS_LANCER then	-- 흑기사, 흑마법사, 요정, 소환술사, 다크로드, 마검사, 레이지파이터, 그로우랜서
		if CharMaster == 0 then
			if UserLv >= 50 and UserLv <= 179 then -- 블러드캐슬 1구간
				QS = LuaQuestClass:GetQuestSwitch(Ep3, iObjIndex)
				if QS >= 0 and QS <= 17 then
					if ProgEp ~= 1 then
						LuaQuestClass:AddQuestExpNpcTalk(Ep3, QS)-- NPC한테 보내줄 퀘스트
			...
			elseif UserLv >= 180 and UserLv <= 269 then -- 블러드캐슬 2구간
				QS = LuaQuestClass:GetQuestSwitch(Ep3, iObjIndex)
				if QS >= 18 and QS <= 35 then
					if ProgEp ~= 1 then
						LuaQuestClass:AddQuestExpNpcTalk(Ep3, QS)-- NPC한테 보내줄 퀘스트
			...
			elseif UserLv >= 270 and UserLv <= 349 then -- 블러드캐슬 3구간
				QS = LuaQuestClass:GetQuestSwitch(Ep3, iObjIndex)
				if QS >= 36 and QS <= 45 then
					if ProgEp ~= 1 then
						LuaQuestClass:AddQuestExpNpcTalk(Ep3, QS)-- NPC한테 보내줄 퀘스트
			...
			elseif UserLv >= 350 and UserLv <= 400 then -- 블러드캐슬 4구간
				QS = LuaQuestClass:GetQuestSwitch(Ep3, iObjIndex)
				if QS >= 46 and QS <= 54 then
					if ProgEp ~= 1 then
						LuaQuestClass:AddQuestExpNpcTalk(Ep3, QS)-- NPC한테 보내줄 퀘스트
		...
		elseif CharMaster == 1 then
			if UserLv >= 400 and UserLv <= 500 then -- 블러드캐슬 5구간
				QS = LuaQuestClass:GetQuestSwitch(Ep3, iObjIndex)
				if QS >= 55 and QS <= 63 then
					if ProgEp ~= 1 then
						LuaQuestClass:AddQuestExpNpcTalk(Ep3, QS)-- NPC한테 보내줄 퀘스트
			...
			elseif UserLv >= 501 and UserLv <= 650 then -- 블러드캐슬 6구간
				QS = LuaQuestClass:GetQuestSwitch(Ep3, iObjIndex)
				if QS >= 64 and QS <= 72 then
					if ProgEp ~= 1 then
						LuaQuestClass:AddQuestExpNpcTalk(Ep3, QS)-- NPC한테 보내줄 퀘스트
			...
			elseif UserLv >= 651 and UserLv <= 770 then -- 블러드캐슬 7구간
				QS = LuaQuestClass:GetQuestSwitch(Ep3, iObjIndex)
				if QS >= 73 and QS <= 81 then
					if ProgEp ~= 1 then
						LuaQuestClass:AddQuestExpNpcTalk(Ep3, QS)-- NPC한테 보내줄 퀘스트
...
function Ep4_NPCTalkList(iObjIndex)
	...
	if CharClass == CLASS_KNIGHT or CharClass == CLASS_WIZARD or CharClass == CLASS_ELF or CharClass == CLASS_SUMMONER or CharClass == CLASS_MAGUMSA or CharClass == CLASS_DARKLORD or CharClass == CLASS_MONK or CharClass == CLASS_LANCER then	-- 흑기사, 흑마법사, 요정, 소환술사, 다크로드, 마검사, 레이지파이터, 그로우랜서
		if CharMaster == 0 then
			if UserLv >= 50 and UserLv <= 179 then -- 악마의광장 1구간
				QS = LuaQuestClass:GetQuestSwitch(Ep4, iObjIndex)
				if QS >= 0 and QS <= 17 then
					if ProgEp ~= 1 then
						LuaQuestClass:AddQuestExpNpcTalk(Ep4, QS)-- NPC한테 보내줄 퀘스트
			...
			elseif UserLv >= 180 and UserLv <= 269 then -- 악마의광장 2구간
				QS = LuaQuestClass:GetQuestSwitch(Ep4, iObjIndex)
				if QS >= 18 and QS <= 35 then
					if ProgEp ~= 1 then
						LuaQuestClass:AddQuestExpNpcTalk(Ep4, QS)-- NPC한테 보내줄 퀘스트
			...
			elseif UserLv >= 270 and UserLv <= 349 then -- 악마의광장 3구간
				QS = LuaQuestClass:GetQuestSwitch(Ep4, iObjIndex)
				if QS >= 36 and QS <= 45 then
					if ProgEp ~= 1 then
						LuaQuestClass:AddQuestExpNpcTalk(Ep4, QS)-- NPC한테 보내줄 퀘스트
			...
			elseif UserLv >= 350 and UserLv <= 400 then -- 악마의광장 4구간
				QS = LuaQuestClass:GetQuestSwitch(Ep4, iObjIndex)
				if QS >= 46 and QS <= 54 then
					if ProgEp ~= 1 then
						LuaQuestClass:AddQuestExpNpcTalk(Ep4, QS)-- NPC한테 보내줄 퀘스트
		...
		elseif CharMaster == 1 then
			if UserLv >= 400 and UserLv <= 500 then -- 악마의광장 5구간
				QS = LuaQuestClass:GetQuestSwitch(Ep4, iObjIndex)
				if QS >= 55 and QS <= 63 then
					if ProgEp ~= 1 then
						LuaQuestClass:AddQuestExpNpcTalk(Ep4, QS)-- NPC한테 보내줄 퀘스트
			...
			elseif UserLv >= 501 and UserLv <= 650 then -- 악마의광장 6구간
				QS = LuaQuestClass:GetQuestSwitch(Ep4, iObjIndex)
				if QS >= 64 and QS <= 72 then
					if ProgEp ~= 1 then
						LuaQuestClass:AddQuestExpNpcTalk(Ep4, QS)-- NPC한테 보내줄 퀘스트
			...
			elseif UserLv >= 651 and UserLv <= 770 then -- 악마의광장 7구간
				QS = LuaQuestClass:GetQuestSwitch(Ep4, iObjIndex)
				if QS >= 73 and QS <= 81 then
					if ProgEp ~= 1 then
						LuaQuestClass:AddQuestExpNpcTalk(Ep4, QS)-- NPC한테 보내줄 퀘스트
...
function Ep16_NPCTalkList(iObjIndex)
	...
	local UserLv     = LuaQuestClass:GetUserLv(iObjIndex)
	local CharClass  = LuaQuestClass:GetCharClass(iObjIndex)
	local FreeServer = LuaQuestClass:IsFreeServer()			-- [ 부분 유료화 체크 ] 1:부분 유료 / 0:유료
